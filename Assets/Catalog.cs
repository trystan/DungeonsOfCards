...
public class Catalog {
	...
	public Catalog() {
		Cards.AddRange(new List<Card>() {
			...
			new Card() { Name = "Attack +1", GoldCost = 2, CardType = CardType.Attack, CombatBonus = 1,
				SpriteName = "DawnLike/Items/MedWep:sword",
				Description = "Increase attack by 1.", },
			new Card() { Name = "Attack +2", GoldCost = 3, CardType = CardType.Attack, CombatBonus = 2,
				SpriteName = "DawnLike/Items/MedWep:sword",
				Description = "Increase attack by 2.", },
			new Card() { Name = "Attack +3", GoldCost = 4, CardType = CardType.Attack, CombatBonus = 3,
				SpriteName = "DawnLike/Items/MedWep:sword",
				Description = "Increase attack by 3.", },
			new Card() { Name = "Attack +4", GoldCost = 5, CardType = CardType.Attack, CombatBonus = 4,
				SpriteName = "DawnLike/Items/MedWep:sword",
				Description = "Increase attack by 4.", },
			new Card() { Name = "Attack focus", GoldCost = 2, CardType = CardType.Normal, OnInHand = CardSpecialEffect.IncreaseAttackSize,
				SpriteName = "DawnLike/Items/MedWep:sword", },

			new Card() { Name = "Defense +1", GoldCost = 2, CardType = CardType.Defense, CombatBonus = 1,
				SpriteName = "DawnLike/Items/Shield:shield",
				Description = "Increase defense by 1.", },
			new Card() { Name = "Defense +2", GoldCost = 3, CardType = CardType.Defense, CombatBonus = 2,
				SpriteName = "DawnLike/Items/Shield:shield",
				Description = "Increase defense by 2.", },
			new Card() { Name = "Defense +3", GoldCost = 4, CardType = CardType.Defense, CombatBonus = 3,
				SpriteName = "DawnLike/Items/Shield:shield",
				Description = "Increase defense by 3.", },
			new Card() { Name = "Defense +4", GoldCost = 5, CardType = CardType.Defense, CombatBonus = 4,
				SpriteName = "DawnLike/Items/Shield:shield",
				Description = "Increase defense by 4.", },
			new Card() { Name = "Defense focus", GoldCost = 2, CardType = CardType.Normal, OnInHand = CardSpecialEffect.IncreaseDefenseSize,
				SpriteName = "DawnLike/Items/Shield:shield", },
			...
			new Card() { Name = "Focus", GoldCost = 2, CardType = CardType.Normal, OnInHand = CardSpecialEffect.IncreaseHandSize,
				SpriteName = "DawnLike/Items/Scroll:card", },
			new Card() { Name = "Miss", GoldCost = 3, CardType = CardType.Defense, DoesBlockOtherCard = true,
				SpriteName = "DawnLike/Objects/Effect0:miss", },
			new Card() { Name = "Evade", GoldCost = 3, CardType = CardType.Defense, DoesStopCombat = true, OnUse = CardSpecialEffect.Evade,
				SpriteName = "DawnLike/Objects/Effect0:miss", },
			...
			new Card() { Name = "Skeleton", GoldCost = 5, CardType = CardType.Defense, OnDie = CardSpecialEffect.SpawnSkeleton,
				SpriteName = "DawnLike/Characters/Undead0:skeleton" },

			new Card() { Name = "Revive", GoldCost = 2, CardType = CardType.Defense, OnDie = CardSpecialEffect.Heal1Health,
				SpriteName = "DawnLike/Items/Potion:big", },
			new Card() { Name = "Rot", GoldCost = -99, CardType = CardType.Normal, OnDraw = CardSpecialEffect.Lose1Health },

			new Card() { Name = "Turn undead", GoldCost = 4, CardType = CardType.Normal, OnUse = CardSpecialEffect.TurnUndead,
				SpriteName = "DawnLike/Characters/Undead0:dark skeleton", },
			new Card() { Name = "Holy attack +1", GoldCost = 3, CardType = CardType.Attack, CombatBonus = 1, StrongVs = "Undead",
				SpriteName = "DawnLike/Items/ShortWep:holy" },
			new Card() { Name = "Holy defense +1", GoldCost = 3, CardType = CardType.Defense, CombatBonus = 1, StrongVs = "Undead",
				SpriteName = "DawnLike/Items/Shield:holy" },
			new Card() { Name = "Mass heal", GoldCost = 4, CardType = CardType.Normal, OnUse = CardSpecialEffect.HealTeam,
				SpriteName = "DawnLike/Items/Potion:big", },
			new Card() { Name = "Pray", GoldCost = 5, CardType = CardType.Normal, OnUse = CardSpecialEffect.Pray,
					SpriteName = "DawnLike/Items/Book:pray", },

			new Card() { Name = "Amulet of attack -2", GoldCost = -99, CardType = CardType.Attack, CombatBonus = -2,
			...
			new Card() { Name = "Amulet of defense -2", GoldCost = -99, CardType = CardType.Defense, CombatBonus = -2,
				SpriteName = "DawnLike/Items/Amulet:amulet",
			...
			new Card() { Name = "Amulet of hands -1", GoldCost = -99, CardType = CardType.Normal, OnInHand = CardSpecialEffect.Discard1FromEachPile,
				SpriteName = "DawnLike/Items/Amulet:amulet",
			...
			new Card() { Name = "Disease touched", GoldCost = -99, CardType = CardType.Defense, OnUse = CardSpecialEffect.AddCardToOther,
				SpriteName = "DawnLike/Characters/Undead0:disease",
				ExtraCard = () => Card("Diseased") },
			new Card() { Name = "Disease touch", GoldCost = -99, CardType = CardType.Attack, OnUse = CardSpecialEffect.AddCardToOther,
				SpriteName = "DawnLike/Characters/Undead0:disease",
				ExtraCard = () => Card("Diseased") },
			new Card() { Name = "Diseased", GoldCost = -99, CardType = CardType.Normal, OnDraw = CardSpecialEffect.Discard1FromEachPile,
				SpriteName = "DawnLike/Characters/Undead0:disease",
				FlavorText = "You weren't fighting undead, were you?" },
			
			new Card() { Name = "Leafs", GoldCost = 0, CardType = CardType.Normal,
				SpriteName = "DawnLike/Characters/Plant0:leafs",
				FlavorText = "Stupid plant people dumping useless leafs everywhere." },

			new Card() { Name = "Plant attack +1", GoldCost = 4, CardType = CardType.Attack, CombatBonus = 1, OnUse = CardSpecialEffect.AddCardToOther, 
				SpriteName = "DawnLike/Characters/Plant0:leafs",
				ExtraCard = () => Card("Leafs") },
			new Card() { Name = "Plant armor +1", GoldCost = 4, CardType = CardType.Defense, CombatBonus = 1, OnUse = CardSpecialEffect.AddCardToOther, 
				SpriteName = "DawnLike/Characters/Plant0:leafs",
				ExtraCard = () => Card("Leafs") },

			new Card() { Name = "Thief's getaway", GoldCost = 4, CardType = CardType.Normal, 
				SpriteName = "DawnLike/items/Boot:boot",
				OnInHand = CardSpecialEffect.IncreaseAllSizes,
				OnUse = CardSpecialEffect.Blink },
			new Card() { Name = "Spear +3", GoldCost = 4, CardType = CardType.Normal, 
			...
			new Card() { Name = "Shield +3", GoldCost = 4, CardType = CardType.Normal, 
			...
			new Card() { Name = "Vestments", GoldCost = 5, CardType = CardType.Normal, 
				SpriteName = "DawnLike/Items/Armor:vestments",
				OnDraw = CardSpecialEffect.Heal1Health,
				OnUse = CardSpecialEffect.HealTeam,
				OnInHand = CardSpecialEffect.IncreaseAllSizes },

			new Card() { Name = "Vampire bite +1", GoldCost = -99, CardType = CardType.Attack, CombatBonus = 1, OnUse = CardSpecialEffect.VampireBite,
					SpriteName = "DawnLike/Characters/Undead0:vampire bite", },
			new Card() { Name = "Ghost form +1", GoldCost = -99, CardType = CardType.Defense, CombatBonus = 1, OnUse = CardSpecialEffect.GhostForm,
				SpriteName = "DawnLike/Characters/Undead0:ghost form", },
			new Card() { Name = "Bones", GoldCost = -99, CardType = CardType.Normal, OnInHand = CardSpecialEffect.IncreaseAllStats,
				SpriteName = "DawnLike/Characters/Undead0:skeleton 2", },
			new Card() { Name = "Zombie rot", GoldCost = -99, CardType = CardType.Normal,
				SpriteName = "DawnLike/Characters/Undead0:zombie",
				OnDraw = CardSpecialEffect.AddCardToOther, ExtraCard = () => Card("Diseased"),
				OnUse = CardSpecialEffect.HealTeam },

			new Card() { Name = "Branches", GoldCost = -99, CardType = CardType.Normal, 
				SpriteName = "DawnLike/Characters/Plant0:tree",
				OnUse = CardSpecialEffect.Draw3,
				OnInHand = CardSpecialEffect.IncreaseAllSizes },
			new Card() { Name = "Bloom", GoldCost = -99, CardType = CardType.Normal, OnUse = CardSpecialEffect.AddCardToOther, ExtraCard = () => Card("Leafs"),
				SpriteName = "DawnLike/Characters/Plant0:bloom" },
			new Card() { Name = "Spores", GoldCost = -99, CardType = CardType.Defense,
			...
			new Card() { Name = "Charge", GoldCost = 5, CardType = CardType.Normal, OnUse = CardSpecialEffect.ChargeNearest,
				SpriteName = "DawnLike/Characters/Plant0:moss man", },

			new Card() { Name = "Aura +2", GoldCost = 3, CardType = CardType.Attack, 
				StrongVs = "Undead", CombatBonus = 2,
				OnDraw = CardSpecialEffect.HealTeam,
				OnUse = CardSpecialEffect.AddCardToOther, ExtraCard = () => Card("Idle"),
				SpriteName = "DawnLike/Objects/Effect0:quick", },
			new Card() { Name = "Poisoned", GoldCost = -99, CardType = CardType.Normal, 
				OnDraw = CardSpecialEffect.Lose1Health, },
			new Card() { Name = "Dart +2", GoldCost = 2, CardType = CardType.Normal, 
			...
			new Card() { Name = "Purge", GoldCost = 5, CardType = CardType.Normal, 
				OnUse = CardSpecialEffect.DestroyBadCard,
				SpriteName = "DawnLike/Items/Ammo:dart", },
			new Card() { Name = "Curse", GoldCost = 2, CardType = CardType.Normal, 
