...
public class ScoreController : MonoBehaviour {
	...
	void Start() {
		...
		var amuletCount = player.DrawStack.Count(c => c.Name.StartsWith("Amulet"))
			+ player.HandStack.Count(c => c.Name.StartsWith("Amulet"))
			+ player.AttackStack.Count(c => c.Name.StartsWith("Amulet"))
			+ player.DefenseStack.Count(c => c.Name.StartsWith("Amulet"))
			+ player.DiscardStack.Count(c => c.Name.StartsWith("Amulet"));
